...
win32: LIBS += -L$$_PRO_FILE_PWD_/SFML-2.5.1/window/lib -lsfml-netwowrk
...
win32:CONFIG(release, debug|release): LIBS += -L$$_PRO_FILE_PWD_/Lib_GameDev/linux/lib/ -lLib_GameDev
else:win32:CONFIG(debug, debug|release): LIBS += -L$$_PRO_FILE_PWD_/Lib_GameDev/linux/lib/ -lLib_GameDev
